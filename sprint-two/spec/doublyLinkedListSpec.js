describe('doublyLinkedList', function() {
  ...
  it('NEW TEST: should check if next node after head is tail', function() {
    doublyLinkedList.addToTail(4);
    doublyLinkedList.addToTail(5);
    expect(doublyLinkedList.head.next.value).to.equal(5);
  });

  it('NEW TEST: should return null when removeHead is called on an empty linked list', function() {
    doublyLinkedList.addToTail(4);
    expect(doublyLinkedList.removeHead()).to.equal(4);
